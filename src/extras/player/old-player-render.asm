...
IFNDEF PLAYER_STUFF_expand_sprites
...
loc_BANKF_F3A6:
	LDA byte_RAM_0
IFNDEF PLAYER_STUFF_UPSIDE_DOWN
    CLC
	ADC #$10
ENDIF
IFDEF PLAYER_STUFF_UPSIDE_DOWN
	SEC
	SBC #$10
    CLC
ENDIF
...
IFDEF PLAYER_STUFF_expand_sprites
    TXA
    CLC
	LDX CurrentCharacter
